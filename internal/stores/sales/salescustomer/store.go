...
type Input struct {
	...
	ContactTitle     string `db:"contact_title" json:"contact_title,omitempty" validate:"max=255"`
	...
	PostalCode       string `db:"postal_code" json:"postal_code,omitempty" validate:"max=255"`
	State            string `db:"state" json:"state,omitempty" validate:"max=255"`
}
