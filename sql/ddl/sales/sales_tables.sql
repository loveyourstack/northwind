...
COMMENT ON TABLE sales.order_detail IS 'shortname: s_od';
--- change columns with ---
CREATE TABLE sales.order_detail_deleted
(
  id bigint NOT NULL PRIMARY KEY,
...
COMMENT ON TABLE sales.order_detail_deleted IS 'shortname: s_od_del';

CREATE INDEX order_detail_order_fk_idx ON sales.order_detail USING btree(order_fk);
CLUSTER sales.order_detail USING order_detail_order_fk_idx;
