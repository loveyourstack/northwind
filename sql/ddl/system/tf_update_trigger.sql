...
CREATE OR REPLACE FUNCTION system.update_trigger()
  RETURNS trigger AS
$BODY$
DECLARE
	v_old_row jsonb;
...
v_new_values := jsonb_diff_val(v_new_row, v_old_row);
...
v_old_values := jsonb_diff_val(v_old_row, v_new_row);

-- record change
INSERT INTO system.data_update (affected_schema, affected_table, affected_old_values, affected_new_values, affected_id, affected_by)
